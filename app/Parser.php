...
final class Parser
{
    private const int READ_CHUNK_SIZE = 786432;
    private const int WRITE_BUFFER_SIZE = 262144;
    ...
    private const int DISCOVER_SIZE = 262144;
    private const int NL_SEARCH_OFFSET = 45;
    ...
    private function writeOutput(
        ...
        foreach ($paths as $pathId => $path) {
            ...
            $fullPathBuffer = $firstPath ? '' : ',';
            $firstPath = false;
            $fullPathBuffer .= "\n    \"{$escapedPath}\": {\n{$pathBuffer}\n    }";
            fwrite($out, $fullPathBuffer);
        }
