...
final class Parser
{
    ...
    private static function writeJson($counts)
    {
        $id = 0;
        $j = '';
        $fu = false;
...
o1:
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-01": '.$counts[$id];
                goto oy1;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-02": '.$counts[$id];
                goto oy2;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-03": '.$counts[$id];
                goto oy3;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-04": '.$counts[$id];
                goto oy4;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-05": '.$counts[$id];
                goto oy5;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-06": '.$counts[$id];
                goto oy6;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-07": '.$counts[$id];
                goto oy7;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-08": '.$counts[$id];
                goto oy8;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-09": '.$counts[$id];
                goto oy9;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-10": '.$counts[$id];
                goto oy10;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-11": '.$counts[$id];
                goto oy11;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-12": '.$counts[$id];
                goto oy12;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-13": '.$counts[$id];
                goto oy13;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-14": '.$counts[$id];
                goto oy14;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-15": '.$counts[$id];
                goto oy15;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-16": '.$counts[$id];
                goto oy16;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-17": '.$counts[$id];
                goto oy17;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-18": '.$counts[$id];
                goto oy18;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-19": '.$counts[$id];
                goto oy19;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-20": '.$counts[$id];
                goto oy20;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-21": '.$counts[$id];
                goto oy21;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-22": '.$counts[$id];
                goto oy22;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-23": '.$counts[$id];
                goto oy23;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-24": '.$counts[$id];
                goto oy24;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-25": '.$counts[$id];
                goto oy25;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-26": '.$counts[$id];
                goto oy26;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-27": '.$counts[$id];
                goto oy27;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-28": '.$counts[$id];
                goto oy28;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-29": '.$counts[$id];
                goto oy29;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-30": '.$counts[$id];
                goto oy30;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-01-31": '.$counts[$id];
                goto oy31;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-01": '.$counts[$id];
                goto oy32;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-02": '.$counts[$id];
                goto oy33;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-03": '.$counts[$id];
                goto oy34;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-04": '.$counts[$id];
                goto oy35;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-05": '.$counts[$id];
                goto oy36;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-06": '.$counts[$id];
                goto oy37;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-07": '.$counts[$id];
                goto oy38;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-08": '.$counts[$id];
                goto oy39;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-09": '.$counts[$id];
                goto oy40;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-10": '.$counts[$id];
                goto oy41;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-11": '.$counts[$id];
                goto oy42;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-12": '.$counts[$id];
                goto oy43;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-13": '.$counts[$id];
                goto oy44;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-14": '.$counts[$id];
                goto oy45;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-15": '.$counts[$id];
                goto oy46;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-16": '.$counts[$id];
                goto oy47;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-17": '.$counts[$id];
                goto oy48;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-18": '.$counts[$id];
                goto oy49;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-19": '.$counts[$id];
                goto oy50;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-20": '.$counts[$id];
                goto oy51;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-21": '.$counts[$id];
                goto oy52;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-22": '.$counts[$id];
                goto oy53;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-23": '.$counts[$id];
                goto oy54;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-24": '.$counts[$id];
                goto oy55;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-25": '.$counts[$id];
                goto oy56;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-26": '.$counts[$id];
                goto oy57;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-27": '.$counts[$id];
                goto oy58;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-28": '.$counts[$id];
                goto oy59;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-02-29": '.$counts[$id];
                goto oy60;
            }
            $id += 2;
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-01": '.$counts[$id];
                goto oy63;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-02": '.$counts[$id];
                goto oy64;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-03": '.$counts[$id];
                goto oy65;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-04": '.$counts[$id];
                goto oy66;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-05": '.$counts[$id];
                goto oy67;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-06": '.$counts[$id];
                goto oy68;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-07": '.$counts[$id];
                goto oy69;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-08": '.$counts[$id];
                goto oy70;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-09": '.$counts[$id];
                goto oy71;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-10": '.$counts[$id];
                goto oy72;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-11": '.$counts[$id];
                goto oy73;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-12": '.$counts[$id];
                goto oy74;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-13": '.$counts[$id];
                goto oy75;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-14": '.$counts[$id];
                goto oy76;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-15": '.$counts[$id];
                goto oy77;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-16": '.$counts[$id];
                goto oy78;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-17": '.$counts[$id];
                goto oy79;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-18": '.$counts[$id];
                goto oy80;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-19": '.$counts[$id];
                goto oy81;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-20": '.$counts[$id];
                goto oy82;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-21": '.$counts[$id];
                goto oy83;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-22": '.$counts[$id];
                goto oy84;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-23": '.$counts[$id];
                goto oy85;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-24": '.$counts[$id];
                goto oy86;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-25": '.$counts[$id];
                goto oy87;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-26": '.$counts[$id];
                goto oy88;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-27": '.$counts[$id];
                goto oy89;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-28": '.$counts[$id];
                goto oy90;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-29": '.$counts[$id];
                goto oy91;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-30": '.$counts[$id];
                goto oy92;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-03-31": '.$counts[$id];
                goto oy93;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-01": '.$counts[$id];
                goto oy94;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-02": '.$counts[$id];
                goto oy95;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-03": '.$counts[$id];
                goto oy96;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-04": '.$counts[$id];
                goto oy97;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-05": '.$counts[$id];
                goto oy98;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-06": '.$counts[$id];
                goto oy99;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-07": '.$counts[$id];
                goto oy100;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-08": '.$counts[$id];
                goto oy101;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-09": '.$counts[$id];
                goto oy102;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-10": '.$counts[$id];
                goto oy103;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-11": '.$counts[$id];
                goto oy104;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-12": '.$counts[$id];
                goto oy105;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-13": '.$counts[$id];
                goto oy106;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-14": '.$counts[$id];
                goto oy107;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-15": '.$counts[$id];
                goto oy108;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-16": '.$counts[$id];
                goto oy109;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-17": '.$counts[$id];
                goto oy110;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-18": '.$counts[$id];
                goto oy111;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-19": '.$counts[$id];
                goto oy112;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-20": '.$counts[$id];
                goto oy113;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-21": '.$counts[$id];
                goto oy114;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-22": '.$counts[$id];
                goto oy115;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-23": '.$counts[$id];
                goto oy116;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-24": '.$counts[$id];
                goto oy117;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-25": '.$counts[$id];
                goto oy118;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-26": '.$counts[$id];
                goto oy119;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-27": '.$counts[$id];
                goto oy120;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-28": '.$counts[$id];
                goto oy121;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-29": '.$counts[$id];
                goto oy122;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-04-30": '.$counts[$id];
                goto oy123;
            }
            ++$id;
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-01": '.$counts[$id];
                goto oy125;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-02": '.$counts[$id];
                goto oy126;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-03": '.$counts[$id];
                goto oy127;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-04": '.$counts[$id];
                goto oy128;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-05": '.$counts[$id];
                goto oy129;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-06": '.$counts[$id];
                goto oy130;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-07": '.$counts[$id];
                goto oy131;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-08": '.$counts[$id];
                goto oy132;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-09": '.$counts[$id];
                goto oy133;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-10": '.$counts[$id];
                goto oy134;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-11": '.$counts[$id];
                goto oy135;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-12": '.$counts[$id];
                goto oy136;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-13": '.$counts[$id];
                goto oy137;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-14": '.$counts[$id];
                goto oy138;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-15": '.$counts[$id];
                goto oy139;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-16": '.$counts[$id];
                goto oy140;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-17": '.$counts[$id];
                goto oy141;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-18": '.$counts[$id];
                goto oy142;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-19": '.$counts[$id];
                goto oy143;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-20": '.$counts[$id];
                goto oy144;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-21": '.$counts[$id];
                goto oy145;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-22": '.$counts[$id];
                goto oy146;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-23": '.$counts[$id];
                goto oy147;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-24": '.$counts[$id];
                goto oy148;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-25": '.$counts[$id];
                goto oy149;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-26": '.$counts[$id];
                goto oy150;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-27": '.$counts[$id];
                goto oy151;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-28": '.$counts[$id];
                goto oy152;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-29": '.$counts[$id];
                goto oy153;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-30": '.$counts[$id];
                goto oy154;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-05-31": '.$counts[$id];
                goto oy155;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-01": '.$counts[$id];
                goto oy156;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-02": '.$counts[$id];
                goto oy157;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-03": '.$counts[$id];
                goto oy158;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-04": '.$counts[$id];
                goto oy159;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-05": '.$counts[$id];
                goto oy160;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-06": '.$counts[$id];
                goto oy161;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-07": '.$counts[$id];
                goto oy162;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-08": '.$counts[$id];
                goto oy163;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-09": '.$counts[$id];
                goto oy164;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-10": '.$counts[$id];
                goto oy165;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-11": '.$counts[$id];
                goto oy166;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-12": '.$counts[$id];
                goto oy167;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-13": '.$counts[$id];
                goto oy168;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-14": '.$counts[$id];
                goto oy169;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-15": '.$counts[$id];
                goto oy170;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-16": '.$counts[$id];
                goto oy171;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-17": '.$counts[$id];
                goto oy172;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-18": '.$counts[$id];
                goto oy173;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-19": '.$counts[$id];
                goto oy174;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-20": '.$counts[$id];
                goto oy175;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-21": '.$counts[$id];
                goto oy176;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-22": '.$counts[$id];
                goto oy177;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-23": '.$counts[$id];
                goto oy178;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-24": '.$counts[$id];
                goto oy179;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-25": '.$counts[$id];
                goto oy180;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-26": '.$counts[$id];
                goto oy181;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-27": '.$counts[$id];
                goto oy182;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-28": '.$counts[$id];
                goto oy183;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-29": '.$counts[$id];
                goto oy184;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-06-30": '.$counts[$id];
                goto oy185;
            }
            ++$id;
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-01": '.$counts[$id];
                goto oy187;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-02": '.$counts[$id];
                goto oy188;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-03": '.$counts[$id];
                goto oy189;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-04": '.$counts[$id];
                goto oy190;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-05": '.$counts[$id];
                goto oy191;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-06": '.$counts[$id];
                goto oy192;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-07": '.$counts[$id];
                goto oy193;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-08": '.$counts[$id];
                goto oy194;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-09": '.$counts[$id];
                goto oy195;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-10": '.$counts[$id];
                goto oy196;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-11": '.$counts[$id];
                goto oy197;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-12": '.$counts[$id];
                goto oy198;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-13": '.$counts[$id];
                goto oy199;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-14": '.$counts[$id];
                goto oy200;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-15": '.$counts[$id];
                goto oy201;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-16": '.$counts[$id];
                goto oy202;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-17": '.$counts[$id];
                goto oy203;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-18": '.$counts[$id];
                goto oy204;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-19": '.$counts[$id];
                goto oy205;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-20": '.$counts[$id];
                goto oy206;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-21": '.$counts[$id];
                goto oy207;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-22": '.$counts[$id];
                goto oy208;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-23": '.$counts[$id];
                goto oy209;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-24": '.$counts[$id];
                goto oy210;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-25": '.$counts[$id];
                goto oy211;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-26": '.$counts[$id];
                goto oy212;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-27": '.$counts[$id];
                goto oy213;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-28": '.$counts[$id];
                goto oy214;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-29": '.$counts[$id];
                goto oy215;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-30": '.$counts[$id];
                goto oy216;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-07-31": '.$counts[$id];
                goto oy217;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-01": '.$counts[$id];
                goto oy218;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-02": '.$counts[$id];
                goto oy219;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-03": '.$counts[$id];
                goto oy220;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-04": '.$counts[$id];
                goto oy221;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-05": '.$counts[$id];
                goto oy222;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-06": '.$counts[$id];
                goto oy223;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-07": '.$counts[$id];
                goto oy224;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-08": '.$counts[$id];
                goto oy225;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-09": '.$counts[$id];
                goto oy226;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-10": '.$counts[$id];
                goto oy227;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-11": '.$counts[$id];
                goto oy228;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-12": '.$counts[$id];
                goto oy229;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-13": '.$counts[$id];
                goto oy230;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-14": '.$counts[$id];
                goto oy231;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-15": '.$counts[$id];
                goto oy232;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-16": '.$counts[$id];
                goto oy233;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-17": '.$counts[$id];
                goto oy234;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-18": '.$counts[$id];
                goto oy235;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-19": '.$counts[$id];
                goto oy236;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-20": '.$counts[$id];
                goto oy237;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-21": '.$counts[$id];
                goto oy238;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-22": '.$counts[$id];
                goto oy239;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-23": '.$counts[$id];
                goto oy240;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-24": '.$counts[$id];
                goto oy241;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-25": '.$counts[$id];
                goto oy242;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-26": '.$counts[$id];
                goto oy243;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-27": '.$counts[$id];
                goto oy244;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-28": '.$counts[$id];
                goto oy245;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-29": '.$counts[$id];
                goto oy246;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-30": '.$counts[$id];
                goto oy247;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-08-31": '.$counts[$id];
                goto oy248;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-01": '.$counts[$id];
                goto oy249;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-02": '.$counts[$id];
                goto oy250;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-03": '.$counts[$id];
                goto oy251;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-04": '.$counts[$id];
                goto oy252;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-05": '.$counts[$id];
                goto oy253;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-06": '.$counts[$id];
                goto oy254;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-07": '.$counts[$id];
                goto oy255;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-08": '.$counts[$id];
                goto oy256;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-09": '.$counts[$id];
                goto oy257;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-10": '.$counts[$id];
                goto oy258;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-11": '.$counts[$id];
                goto oy259;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-12": '.$counts[$id];
                goto oy260;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-13": '.$counts[$id];
                goto oy261;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-14": '.$counts[$id];
                goto oy262;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-15": '.$counts[$id];
                goto oy263;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-16": '.$counts[$id];
                goto oy264;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-17": '.$counts[$id];
                goto oy265;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-18": '.$counts[$id];
                goto oy266;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-19": '.$counts[$id];
                goto oy267;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-20": '.$counts[$id];
                goto oy268;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-21": '.$counts[$id];
                goto oy269;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-22": '.$counts[$id];
                goto oy270;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-23": '.$counts[$id];
                goto oy271;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-24": '.$counts[$id];
                goto oy272;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-25": '.$counts[$id];
                goto oy273;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-26": '.$counts[$id];
                goto oy274;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-27": '.$counts[$id];
                goto oy275;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-28": '.$counts[$id];
                goto oy276;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-29": '.$counts[$id];
                goto oy277;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-09-30": '.$counts[$id];
                goto oy278;
            }
            ++$id;
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-01": '.$counts[$id];
                goto oy280;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-02": '.$counts[$id];
                goto oy281;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-03": '.$counts[$id];
                goto oy282;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-04": '.$counts[$id];
                goto oy283;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-05": '.$counts[$id];
                goto oy284;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-06": '.$counts[$id];
                goto oy285;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-07": '.$counts[$id];
                goto oy286;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-08": '.$counts[$id];
                goto oy287;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-09": '.$counts[$id];
                goto oy288;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-10": '.$counts[$id];
                goto oy289;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-11": '.$counts[$id];
                goto oy290;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-12": '.$counts[$id];
                goto oy291;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-13": '.$counts[$id];
                goto oy292;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-14": '.$counts[$id];
                goto oy293;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-15": '.$counts[$id];
                goto oy294;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-16": '.$counts[$id];
                goto oy295;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-17": '.$counts[$id];
                goto oy296;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-18": '.$counts[$id];
                goto oy297;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-19": '.$counts[$id];
                goto oy298;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-20": '.$counts[$id];
                goto oy299;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-21": '.$counts[$id];
                goto oy300;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-22": '.$counts[$id];
                goto oy301;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-23": '.$counts[$id];
                goto oy302;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-24": '.$counts[$id];
                goto oy303;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-25": '.$counts[$id];
                goto oy304;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-26": '.$counts[$id];
                goto oy305;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-27": '.$counts[$id];
                goto oy306;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-28": '.$counts[$id];
                goto oy307;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-29": '.$counts[$id];
                goto oy308;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-30": '.$counts[$id];
                goto oy309;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-10-31": '.$counts[$id];
                goto oy310;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-01": '.$counts[$id];
                goto oy311;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-02": '.$counts[$id];
                goto oy312;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-03": '.$counts[$id];
                goto oy313;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-04": '.$counts[$id];
                goto oy314;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-05": '.$counts[$id];
                goto oy315;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-06": '.$counts[$id];
                goto oy316;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-07": '.$counts[$id];
                goto oy317;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-08": '.$counts[$id];
                goto oy318;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-09": '.$counts[$id];
                goto oy319;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-10": '.$counts[$id];
                goto oy320;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-11": '.$counts[$id];
                goto oy321;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-12": '.$counts[$id];
                goto oy322;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-13": '.$counts[$id];
                goto oy323;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-14": '.$counts[$id];
                goto oy324;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-15": '.$counts[$id];
                goto oy325;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-16": '.$counts[$id];
                goto oy326;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-17": '.$counts[$id];
                goto oy327;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-18": '.$counts[$id];
                goto oy328;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-19": '.$counts[$id];
                goto oy329;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-20": '.$counts[$id];
                goto oy330;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-21": '.$counts[$id];
                goto oy331;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-22": '.$counts[$id];
                goto oy332;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-23": '.$counts[$id];
                goto oy333;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-24": '.$counts[$id];
                goto oy334;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-25": '.$counts[$id];
                goto oy335;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-26": '.$counts[$id];
                goto oy336;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-27": '.$counts[$id];
                goto oy337;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-28": '.$counts[$id];
                goto oy338;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-29": '.$counts[$id];
                goto oy339;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-11-30": '.$counts[$id];
                goto oy340;
            }
            ++$id;
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-01": '.$counts[$id];
                goto oy342;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-02": '.$counts[$id];
                goto oy343;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-03": '.$counts[$id];
                goto oy344;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-04": '.$counts[$id];
                goto oy345;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-05": '.$counts[$id];
                goto oy346;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-06": '.$counts[$id];
                goto oy347;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-07": '.$counts[$id];
                goto oy348;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-08": '.$counts[$id];
                goto oy349;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-09": '.$counts[$id];
                goto oy350;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-10": '.$counts[$id];
                goto oy351;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-11": '.$counts[$id];
                goto oy352;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-12": '.$counts[$id];
                goto oy353;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-13": '.$counts[$id];
                goto oy354;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-14": '.$counts[$id];
                goto oy355;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-15": '.$counts[$id];
                goto oy356;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-16": '.$counts[$id];
                goto oy357;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-17": '.$counts[$id];
                goto oy358;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-18": '.$counts[$id];
                goto oy359;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-19": '.$counts[$id];
                goto oy360;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-20": '.$counts[$id];
                goto oy361;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-21": '.$counts[$id];
                goto oy362;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-22": '.$counts[$id];
                goto oy363;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-23": '.$counts[$id];
                goto oy364;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-24": '.$counts[$id];
                goto oy365;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-25": '.$counts[$id];
                goto oy366;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-26": '.$counts[$id];
                goto oy367;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-27": '.$counts[$id];
                goto oy368;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-28": '.$counts[$id];
                goto oy369;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-29": '.$counts[$id];
                goto oy370;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-30": '.$counts[$id];
                goto oy371;
            }
            if ($counts[++$id]) {
                $j .= '        "'.$year.'-12-31": '.$counts[$id];
                goto oy372;
            }
...
o2:
    ...
    private static function parseFileSequence()
    {
        ...
        $counts = \array_fill(0, self::$countsSize, 0);

        $id = 0;
        $sequence = [];
        $sequenceRem = \count($partialIds);
...
s1:
        ...
        do {
            ...
            $bp = 52 + $i;
            if (!isset($sequenceUsed[$id])) {
                $sequenceUsed[$id] = true;
                $sequence[] = $id;
                if (0 === (--$sequenceRem)) {
                    self::$sequence = $sequence;
                    return [$counts, $b, $bp, $bm];
                }
            }
        } while ($bp<$bm);
        ...
        if ($bp === (25+\strlen($b))) {
            if (0 === \strlen($b = \fread($f, self::BUFFER_SIZE))) {
                self::$sequence = $sequence;
                return [$counts, $b, $bp, $bm];
            }
            $bp = 25;
...
l1e:
    ...
    public final static function parse(string $inputPath, string $outputPath): void
    {
        ...
        self::initialize();
        $counts = self::parseFile();
        self::writeJson($counts);
    }
}