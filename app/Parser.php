...
final class Parser
{
    ...
    private function process(string $inputPath, int $resultArraySize, int $linksCount): array
    {
        ...
        while ($start < $end && count($order) < $linksCount) {
            ...
            while ($o < $endData) {
                ...
                $link = substr($data, $o + self::URL_FIXED_LENGTH, $c - $o - self::URL_FIXED_LENGTH);
                $order[$link] = 0;

                $res[self::DATA_POINTS * match ($data[$c - 22]) {
                    'w' => 0,
                    's' => match ($data[$c - 18]) {
                        's' => match ($data[$c - 13]) {
                            'i' => match ($data[$c - 1]) {
    ...
    public function parse(string $inputPath, string $outputPath): void
    {
        ...
        [$res, $order] = $this->process($inputPath, count($linkToIndex) * self::DATA_POINTS, count($linkToIndex));
